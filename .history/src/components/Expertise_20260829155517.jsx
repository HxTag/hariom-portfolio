...
const expertiseData = [
  {
    ...
    text: "Building practical software solutions using Python, Java, C, and C++, with a strong focus on problem-solving, programming fundamentals, and efficient application development.",
  ...
  },
  {
    ...
    text: "Developing responsive and interactive web applications using HTML, CSS, JavaScript, React, and Node.js, while focusing on clean interfaces and practical user experiences.",
  ...
  },
  {
    ...
    text: "Exploring machine learning and artificial intelligence through Python-based projects, predictive models, data analysis, and practical applications that transform data into useful insights.",
  ...
  },
  {
    ...
    text: "Working with MongoDB and MySQL for data management while using Git, GitHub, and development tools to organize, manage, and maintain software projects efficiently.",
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full space-y-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2">
          ...
          <p className="text-white/60 text-xs md:text-sm font-light leading-relaxed max-w-xs">
            Combining programming, web development, AI & machine learning, and database technologies to build practical software solutions.
          </p>
        </div>
