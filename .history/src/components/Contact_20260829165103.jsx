...
const Contact = () => {
  ...
  // =====================================================
  const SERVICE_ID = 'service_katca0e';
  const TEMPLATE_ID = 'template_owljpqd';
  const PUBLIC_KEY = 'HDEZniB1KVple2bD8';
    ...
    try {
      await emailjs.send(
        ...
        TEMPLATE_ID,
        {
          ...
          // Extra variables you can use in EmailJS template
      ...
      <div className="relative z-10 w-full flex justify-end items-end">
        ...
        <motion.div
          ...
          className="
            ...
            justify-between
            rounded-tl-[3rem]
            shadow-[0_-25px_60px_rgba(0,0,0,0.9)]
            relative
            overflow-hidden
          "
        >
              ...
              >
                ...
                >
                  ...
                  <p className="max-w-[250px] leading-relaxed">
                    Ready to start a project or collaboration?
                    Send a direct signal to Hariom.
                  </p>
                ...
                {status === 'permission' && (
                  <p className="text-yellow-400 font-mono text-xs">
                    ! PLEASE ACCEPT CONTACT PERMISSION.
                  </p>
                )}
