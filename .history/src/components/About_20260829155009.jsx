        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
            ...
            <div className="space-y-5 relative z-10">
              ...
              <p className="text-lg md:text-xl font-medium text-white/90 leading-relaxed">
                I am <span className="text-white font-bold drop-shadow">Hariom Pandey</span>, an MCA student specializing in Artificial Intelligence and Machine Learning.
              </p>
              <p className="text-sm md:text-base text-white/60 font-light leading-relaxed">
                My technical journey combines problem-solving, software development, and machine learning, with a focus on building practical applications and turning ideas into efficient, user-friendly solutions.
              </p>
            </div>
            ...
            <div className="pt-8 flex flex-wrap gap-2 relative z-10">
              ...
              <span className="px-3.5 py-1.5 rounded bg-white/5 border border-white/10 text-xs font-mono text-white/80">Software Development</span>
            </div>
          </div>
            ...
            <div className="space-y-5 relative z-10">
              ...
              <ul className="space-y-3.5 text-sm text-white/80 font-light">
                <li className="flex items-start gap-2.5">
                  ...
                  <span>Completed <strong className="text-white">Bachelor of Computer Applications (BCA)</strong> with a strong foundation in computer science and software development.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-red-500 font-bold">&#8250;</span>
                  <span>Currently pursuing <strong className="text-white">Master of Computer Applications (MCA)</strong> with a focus on Artificial Intelligence and Machine Learning.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-red-500 font-bold">&#8250;</span>
                  <span>Developing projects across <strong className="text-white">Python, Java, Machine Learning, Web Development, and Databases</strong>.</span>
                </li>
              </ul>
            </div>
          ...
          >
            ...
            <div className="space-y-2 text-left relative z-10">
              ...
              <p className="text-base md:text-lg font-semibold text-white">Equipped with technologies for building practical and scalable applications.</p>
            </div>
            
            <div className="flex flex-wrap items-center gap-3 relative z-10">
              {['Python', 'Java', 'C++', 'JavaScript', 'React', 'Node.js', 'MongoDB', 'MySQL'].map((tech, idx) => (
                <span
                  key={idx}
