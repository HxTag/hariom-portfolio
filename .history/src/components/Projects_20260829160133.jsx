...
const projectsData = [
  {
    ...
    description: "Machine learning project for analyzing historical currency exchange data and predicting future exchange rates using Python and ML techniques.",
  ...
  },
  {
    ...
    description: "Collaborative study platform that allows students to create and join study groups, communicate in real time, share resources, and manage study sessions.",
  ...
  },
  {
    ...
    description: "Computer vision system designed to detect eye states through a camera and provide real-time alerts when eyes remain closed or the user moves away from the camera.",
  ...
  },
  {
    ...
    description: "Cinematic developer portfolio inspired by Netflix, featuring interactive animations, responsive layouts, custom cursor effects, and GSAP-powered interactions.",
  ...
  },
  {
    ...
    description: "Data analysis project for evaluating employee compensation equality across factories and job roles using equality scores and structured Excel data.",
  ...
  },
  {
    ...
    description: "Web application developed using Flask and MySQL with database connectivity, data handling, and server-side application functionality.",
  ...
  },
  {
    ...
    description: "Collection of practical AI and machine learning projects involving data preprocessing, model development, prediction, and intelligent automation.",
  ...
  },
  {
    ...
    description: "Personal developer profile showcasing technical skills, projects, certifications, achievements, and software development experience.",
      ...
      mm.add({
        ...
        if (isDesktop) {
          ...
          tl.to(cardsRef.current, {
            x: (i) => {
              const w = Math.max(
                ...cardsRef.current.map(c => c?.offsetWidth || 0)
              ) || 360;
            ...
            y: (i) => {
              const h = Math.max(
                ...cardsRef.current.map(c => c?.offsetHeight || 0)
              ) || 240;
